...
//
// MUHIM tartib (foydalanuvchi talabi — 2026-06-01 yangilandi):
//   1) subTotal  = taomlar yig'indisi (snapshot narx × effective qty)
//   2) service   = subTotal asosida (usluga foizi)
...
//
// Ya'ni skidka usluga qo'shilgan summadan olinadi (mas. 2900 + 1450 = 4350, 10% = 435).
...
// Soatlik taom summasi — DAQIQALI prorata (frontend computeHourlyForItem bilan BIR XIL).
// To'langan/to'xtatilgan → muzlatilgan hourlyFinalAmount. Aks holda jonli (now gacha).
// amount = (o'tgan_ms / 1soat) × hourlyPrice × miqdor.
