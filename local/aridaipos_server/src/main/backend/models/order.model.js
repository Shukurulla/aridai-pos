      ...
      type: [
        {
          ...
          // Soatlik taom (PlayStation, kabina...) — vaqt bo'yicha hisoblanadi.
          // hourlyPrice = soatlik stavka; summa = (o'tgan vaqt/soat)×price×qty.
          // To'lov payti hourlyStoppedAt + hourlyFinalAmount muzlatiladi.
